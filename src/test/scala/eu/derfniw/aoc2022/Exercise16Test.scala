...
class Exercise16Test extends AocTestSuite:
  ...
  testSample("Part one on sample input", sample, ex16.run01, 1651)
  //testSample("Part two on sample input", sample, ex16.run02, ???)
